...
template = DocxTemplate('Template - IBM - RedHat OCP Assessment Report v1.docx')
table_cat1 = []
table_cat2 = []
table_cat3 = []
table_cat4 = []
...
for row in range(10, sheet_1.max_row + 1):
    if(sheet_1.cell(row, 1).value == categories[0]):
        ...
        score[0]+=int(sheet_1.cell(row, 6).value*sheet_1.cell(row, 7).value)
        table_cat1.append({
            #'Index': row-1,
        ...
        score[1]+=int(sheet_1.cell(row, 6).value*sheet_1.cell(row, 7).value)
        table_cat2.append({
            #'Index': row-1,
            'Category' : sheet_1.cell(row, 1).value,
            'Question' : sheet_1.cell(row, 2).value,
        ...
        score [2]+=int(sheet_1.cell(row, 6).value*sheet_1.cell(row, 7).value)
        table_cat3.append({
            #'Index': row-1,
            'Category' : sheet_1.cell(row, 1).value,
            'Question' : sheet_1.cell(row, 2).value,
        ...
        score[3]+=int(sheet_1.cell(row, 6).value*sheet_1.cell(row, 7).value)
        table_cat4.append({
            #'Index': row-1,
            'Category' : sheet_1.cell(row, 1).value,
            'Question' : sheet_1.cell(row, 2).value,
        ...
        score[4]+=int(sheet_1.cell(row, 6).value*sheet_1.cell(row, 7).value)
        table_cat5.append({
            #'Index': row-1,
            'Category' : sheet_1.cell(row, 1).value,
            'Question' : sheet_1.cell(row, 2).value,
